...
attack_cooldown = 30 - (global.fire_rate_upgrades * 2);
current_attack_cooldown = 0;

// sprites
sprite[RIGHT] = player_crab_move_right;
sprite[UP] = player_crab_move_up;
sprite[LEFT] = player_crab_move_left;
sprite[DOWN] = player_crab_move_down;
sprite[IDLE_RIGHT] = player_crab_idle_right;
sprite[IDLE_UP] = player_crab_idle_up;
sprite[IDLE_LEFT] = player_crab_idle_left;
sprite[IDLE_DOWN] = player_crab_idle_down;
