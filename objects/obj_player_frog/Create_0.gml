...
attack_cooldown = 15 - (global.fire_rate_upgrades * 0.1);
current_attack_cooldown = 0;

// sprites
sprite[RIGHT] = player_frog_move_right;
sprite[UP] = player_frog_move_up;
sprite[LEFT] = player_frog_move_left;
sprite[DOWN] = player_frog_move_down;
sprite[IDLE_RIGHT] = player_frog_idle_right;
sprite[IDLE_UP] = player_frog_idle_up;
sprite[IDLE_LEFT] = player_frog_idle_left;
sprite[IDLE_DOWN] = player_frog_idle_down;
